...
if (isset($_GET['del'])) {
    ...
    if (mysqli_query($connection, $delete_query)) {
        header("Location: admin_crud.php"); // Corrected filename
        exit();
    } else {
                                ...
                                foreach ($data as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger"><a href='admin_crud.php?del=<?php echo $row['id']; ?>' class="text-light">Delete</a></button>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
